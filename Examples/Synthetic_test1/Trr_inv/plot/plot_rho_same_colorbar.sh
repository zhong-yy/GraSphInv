...
gmt begin inversion_model_Trr eps E300
#	gmt set FONT_TITLE 9p
#	gmt set MAP_TITLE_OFFSET 9p 
	gmt set FONT 9p
	gmt set MAP_FRAME_TYPE plain
	gmt set MAP_FRAME_PEN 0.25p,black
	gmt set MAP_ANNOT_MIN_SPACING 10p
	#gmt set FORMAT_GEO_MAP ddd:mm:ssF
	# gmt set IO_LONLAT_TOGGLE true
        gmt makecpt -Cwysiwyg  -T-200/200  -D -Ic -H > mycpt.cpt #Cwysiwyg
        mycpt=mycpt.cpt
		...
		gmt colorbar -DJMR+w4.3c/0.2c+o1c/1.9c+e -Bxa50f10 -By+L"kg/m@+3@+" -C$mycpt
