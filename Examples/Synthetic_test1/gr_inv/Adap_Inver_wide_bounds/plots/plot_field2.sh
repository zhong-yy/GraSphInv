...
gmt begin synthetic_test_gr_misfit jpg,eps E300
	gmt set FONT 9p
	...
	gmt set FORMAT_GEO_MAP ddd:mm:ssF
		...
		gmt basemap  -JX4.3c/4.6c -R-35/35/0/450 -BWSrt -Bxa20f5+l"Residual value (mGal)" -Bya100f100+l"Counts" -X6.5c -Y-0.2c
