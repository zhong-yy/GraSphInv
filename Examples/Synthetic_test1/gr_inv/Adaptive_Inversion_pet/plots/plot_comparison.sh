...
model2=../../Non-adaptive_Inversion_pet/non_ada_result_crg_pet.nc
...
interpolation=n
gmt begin compare_result_crg eps E300
...
#	gmt set MAP_TITLE_OFFSET 9p 
	...
	# gmt set IO_LONLAT_TOGGLE true
        gmt makecpt -Cwysiwyg  -T-110/110 -D -Ic -H > mycpt.cpt #wysiwyg
        mycpt=mycpt.cpt
		...
		#gmt plot $true_model_hori -W1.p,white,
...
EOF
		...
		#gmt plot $true_model_lon1 -W1.p,white,
		...
		#gmt plot $true_model_lon2 -W1.p,white,
