...
gmt begin synthetic_test_gr_model_pet jpg,eps E300
...
#	gmt set MAP_TITLE_OFFSET 9p 
	...
	#gmt set FORMAT_GEO_MAP ddd:mm:ssF
        gmt makecpt -Cwysiwyg -T-120/120/1 -D -Ic -H > mycpt.cpt
        mycpt=mycpt.cpt
		...
		gmt colorbar -DJMR+w3.9c/0.2c+o1.0c/1.6c+e -Bxa40f10 -By+L"kg/m@+3@+" -C$mycpt
		...
		gmt basemap -JPa4.9c/30z -R$Region3  -BENsw -Y+3.1c -Bxafg -Bya200f50g100 -Bya200f50g100
