model=../non_ada_result_crg_pet.nc
...
$extract_slice_tool $model $rslice r 6253137
...
gmt begin synthetic_test_fixed_mesh_gr_model_no_cst jpg E300
	...
	gmt set FORMAT_GEO_MAP ddd:mm:ssF
        gmt makecpt -Cseis -T-200/200/0.1 -H > mycpt.cpt
        mycpt=wysiwyg
		...
		gmt basemap -JPa5.5c/30z -R$Region3  -BWNse  -Bxafg -Bya200fg+l"km" -Y+5c
		...
		echo "(a) Depth=125 km" | gmt text -F+cTL+f10p, -D0.5c/0.9c -N
