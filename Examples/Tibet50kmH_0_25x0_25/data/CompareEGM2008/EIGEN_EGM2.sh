...
gmt grd2cpt $EIGEN6C4_FIELD"_grd" $EGM_FIELD"_grd" "residual_grd" -Ic -Chaxby -E -Z
...
gmt basemap -JX4.69c/3.49c -R-15/15/0/8000 -BWSrt -Bxa10f5+l"Differences (mGal)" -Bya+l"Counts" -X7.05 -Y0.11 --MAP_FRAME_PEN=1.p
