...
ct_lb_d=d1.5c
#ct_lb_d=n1/1.9c -Gd1c
gmt begin vslice_with_constraints jpg,eps E300
gmt set FONT 9p
...
gmt grdcontour slice0 -A$contours -G$ct_lb_d -W0.5p,black
gmt grdcontour slice0 -A$contours2 -G$ct_lb_d -W0.25p,black,-
gmt plot moho0 -W0.5p,black,dashed -Gwhite -t30
gmt plot moho0 -Wthick,black,dashed
Ra=($(gmt gmtinfo -I- -C elevation0))
ele0=${Ra[2]}
...
gmt grdcontour slice1 -A$contours -G$ct_lb_d -W0.5p,black
gmt grdcontour slice1 -A$contours2 -G$ct_lb_d -W0.25p,black,-
gmt plot moho0 -W0.5p,black,dashed -Gwhite -t30
gmt plot moho0 -Wthick,black,dashed
...
gmt grdcontour slice2 -A$contours -G$ct_lb_d -W0.5p,black
gmt grdcontour slice2 -A$contours2 -G$ct_lb_d -W0.25p,black,-
gmt plot moho0 -W0.5p,black,dashed -Gwhite -t30
gmt plot moho0 -Wthick,black,dashed
...
gmt grdcontour slice3 -A$contours -G$ct_lb_d -W0.5p,black
gmt grdcontour slice3 -A$contours2 -G$ct_lb_d -W0.25p,black,-
gmt plot moho0 -W0.5p,black,dashed -Gwhite -t30
gmt plot moho0 -Wthick,black,dashed
Rd=($(gmt gmtinfo -I- -C elevation3))
